...
def _parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='+',
        default=['weights/Wan2.1_I2V_14B_FusionX_LoRA.safetensors'],
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                #     value="VideoDubbing"
                # )
                task_mode = gr.Textbox(value="SingleImageDriven", visible=False)
                ...
                with gr.Accordion("Audio Options", open=True):
                    mode_selector = gr.Radio(
                        choices=["Single Person(Local File)", "Single Person(TTS)"],
                    ...
                    # )
                    resolution_select = gr.Textbox(value="infinitetalk-480", visible=False)
                    ...
                    # Dummy component for audio 2 to keep function signatures valid
                    img2vid_audio_2 = gr.Audio(label="Conditioning Audio for speaker 2", type="filepath", visible=False, value=None)
